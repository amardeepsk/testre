...
import com.woocommerce.android.ui.widgets.stats.TodayUIMessageResolver
import com.woocommerce.android.ui.widgets.stats.TodayWidgetConfigureFragment
import com.woocommerce.android.ui.widgets.stats.TodayWidgetConfigureModule
import dagger.Binds
...
object WidgetModule {
    ...
    abstract class TodayWidgetConfigureActivityModule {
        @ActivityScope
        @Binds
        abstract fun provideUiMessageResolver(todayUIMessageResolver: TodayUIMessageResolver): UIMessageResolver
    }
