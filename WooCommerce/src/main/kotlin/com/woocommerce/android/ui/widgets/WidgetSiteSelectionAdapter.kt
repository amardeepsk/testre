...
import kotlinx.android.synthetic.main.dialog_widget_site_selector_item.view.*
...
class WidgetSiteSelectionAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WidgetSiteSelectionViewHolder {
        return WidgetSiteSelectionViewHolder(
            LayoutInflater.from(context).inflate(R.layout.dialog_widget_site_selector_item, parent, false)
        )
    }
